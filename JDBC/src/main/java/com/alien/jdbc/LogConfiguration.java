...
public class LogConfiguration {
	...
	/**
	 * 用于动态生成各个模块中的每条用例的日志，运行完成用例之后请到result/log目录下查看
	 * 
	 * @param moduleName
	 *            模块的名称
	 * @param fileName
	 *            日志文件名称
	 */
	public static void initLog(String moduleName, String fileName) {
		// 声明日志文件存储路径以及文件名、格式
		final String logFilePath = "./result/log/" + moduleName + "/"
				+ fileName + ".log";
